	...
	class Panel extends JPanel {
		...
		public void paintComponent(Graphics comp) {
			...
			if (b.root != null) {
				...
				Node n = new Node(this.getWidth() / 2 - 12.5, 25,
						(Integer) root.getElement(), (Integer) root.adjustHeight());
				n.drawOn(comp2D);
		...
		public void drawRec(Node n, AVLTree.BinaryNode par,
			...
			if (par.getLeftChild() != null) {
				...
				n.translate(x - TRANSX, y + TRANSY, (Integer) apar.getElement(), (Integer) apar.adjustHeight());
				n.drawOn(comp2D);
			...
			if (par.getRightChild() != null) {
				...
				n.translate(x + TRANSX, y + TRANSY, (Integer) bpar.getElement(), (Integer) bpar.adjustHeight());
				n.drawOn(comp2D);
		...
		class Node extends JComponent {
			...
			public void drawOn(Graphics2D g2) {
				Ellipse2D.Double cir = new Ellipse2D.Double(this.CenterX,
						this.CenterY, this.radius + 5, this.radius);
				g2.draw(cir);
